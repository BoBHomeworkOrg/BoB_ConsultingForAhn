...
int main()
{
    ...
    /// 256 -> we have to be able to encrypt every plain-text input byte [0-0xff]
    ...
    for (size_t r = 0; r < 10; ++r)
    {
        ...
        for (size_t i = 0; i < 16; ++i)
        {
            ...
            for (size_t x = 0; x < 256; ++x)
            {
                ...
                Tboxes[r][i][x] = sbox[x ^ round_keys[r][i]];
    ...
    for (size_t r = 0; r < 9; ++r)
    {
        ...
        for (size_t i = 0; i < 16; ++i)
        {
            ...
            for (size_t x = 0; x < 256; ++x)
            {
                ...
                unsigned char c = sbox[x ^ round_keys[r][i]];
    ...
    printf("const unsigned char Tboxes_[16][256] = \n{\n");
    for (size_t i = 0; i < 16; ++i)
    {
        printf("  {\n    ");
        for (size_t x = 0; x < 256; ++x)
        {
            ...
            Tboxes[9][i][x] = sbox[x ^ round_keys[9][i]] ^ round_keys[10][i];
